...
args = {
    ...
    'data_transfer_queue': 'dtn-tem1', # airflow worker queue for data transfers
    'dry_run': False,
}
...
with DAG( os.path.splitext(os.path.basename(__file__))[0],
    ...
    slack_users = SlackAPIInviteToChannelOperator( task_id='slack_users',
        ...
        default_users="W016KT5Q7GB,W8WBPL02K,W9RUM1ET1,U0541LTRE49,U07AYA07XUH,U07TNF58UTY"
    )
